      ...
      <Routes>
        ...
        <Route element={<AuthenticatedLayout />}>
          ...
          <Route
            ...
            element={<JointVerificationPage />}
          />
          <Route
            path="/inspections/:id/locked"
            element={<BaselineLockedPage />}
          />

          {/* Return inspection */}
          <Route
            path="/inspections/:id/return"
            element={<ReturnInspectionStartPage />}
          />
          <Route
            path="/inspections/:id/return/capture"
          ...
          />
          <Route
            path="/inspections/:id/compare/:area"
